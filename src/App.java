...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Do you want to import the file of student? (Y/N): ");
        String importChoice = scanner.nextLine();
        if (importChoice.equalsIgnoreCase("Y")) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    System.out.print("Do you want to export data before exiting? (Y/N): ");
                    ...
                    switch (exportChoice) {
                        ...
                        case "N":
                            ...
                            break;
                        default:
                            System.out.println("Invalid input. Exiting without exporting.");
                    }
